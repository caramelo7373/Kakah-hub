...
local Window = redzlib:MakeWindow({
  Title = "kakah Hub | Brookhaven 1.0🇧🇷",
  SubTitle = "by kakah e diel",
  SaveFolder = "Versão 1.0| kakah hub"
})

Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://104780834285034", BackgroundTransparency = 0 },
...
Tab1:AddDiscordInvite({
    ...
    Logo = "rbxassetid://104780834285034",
    Invite = "https://discord.gg.nada",
})

local Section = Tab1:AddSection({"Credits"})

local Paragraph = Tab1:AddParagraph({"Criador", "kakah e diel"})

local Paragraph = Tab1:AddParagraph({"Versão", "1.0"})
...
local Window = WindUI:CreateWindow({
    ...
    KeySystem = {
        Key = { "Userkahah", "PainelAdm" },
        Note = "⚒️Painel Key Staff⚒️",
        Thumbnail = {
            Image = "rbxassetid://104780834285034",
            Title = "Key system",
        },
